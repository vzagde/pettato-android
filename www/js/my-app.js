var base_url = 'https://pettato.com/index.php/api/';
var image_url = 'https://pettato.com/assets/uploads/upload_image/';
...
myApp.onPageInit('profile-user', function(page) {
    // loadChatsList();
    loadProfileUserContent(account_default_id);
});

myApp.onPageInit('profile-user-sub', function(page) {
    // loadChatsList();
    loadProfileUserSubContent(static_account_id);
});

myApp.onPageInit('profile-business', function(page) {
    business_static_account_id = page.query.id;
    loadProfileBusinessContent(business_static_account_id);
    // loadChatsList();
});

myApp.onPageInit('profile-business-sub', function(page) {
    business_static_account_id = page.query.id;
    loadProfileBusinessSubContent(business_static_account_id);
